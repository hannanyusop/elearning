...
<div class="wrapper">
  ...
  <!-- =============================================== -->
      ...
      $sql = "SELECT * FROM parent ORDER BY fullname ASC";
            ...
            ?>
                <tr>
                  ...
                  <td><?php echo $data['email']?></td>
                    ...
                    <?php  echo '<td>  
          <a href="../admin/viewchildren.php?id='.$data['parent_ID'].'"> '?>
            <button type = "button"  class="btn-primary btn-flat margin"> View Children </button></a>
